...
class ApiCompletenessLifecycleTest {
    ...
    @Test
    fun testProjectsLifecycle() = runBlocking {
    ...
    @Test
    fun testProposalsLifecycle() = runBlocking {
    ...
    @Test
    fun testReviewsAndAccountDeactivation() = runBlocking {
    ...
    @Test
    fun testChangePasswordFlow() = runBlocking {
        ...
        coEvery { repo.updatePassword("user_test", any()) } returns true
    ...
    @Test
    fun testNotificationReadStatus() = runBlocking {
