...
class SecurityAuditRemediationTest {
    ...
    @Test
    fun testResetPasswordShortPasswordFails() = runBlocking {
        val ex = assertFailsWith<ApiException> {
    ...
    @Test
    fun testResetPasswordInvalidOtpFails() = runBlocking {
    ...
    @Test
    fun testProposalsBolaProtectionBlocksNonOwner() = runBlocking {
    ...
    @Test
    fun testProposalsAntiSelfBiddingBlocksOwner() = runBlocking {
        // Project belongs to user_owner
        coEvery { proposalsRepository.getProjectOwnerId("proj_100") } returns "user_owner"
