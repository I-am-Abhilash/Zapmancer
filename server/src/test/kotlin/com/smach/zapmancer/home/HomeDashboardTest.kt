...
import com.smach.zapmancer.home.repository.HomeUserContext
...
class HomeDashboardTest {
    ...
    fun testGetDashboard() {
        runBlocking {
            ...
            coEvery { repo.getUserContext("usr_1") } returns HomeUserContext(name = "David", isClientMode = true)
            coEvery { repo.getActiveProjectsCount("usr_1") } returns 3
            coEvery { repo.getCapacity("usr_1") } returns 10
            ...
            assertEquals(10, dashboard.totalCapacity)
